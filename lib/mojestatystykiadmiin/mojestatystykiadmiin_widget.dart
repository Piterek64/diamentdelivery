...
import '/components/datyadim_widget.dart';
import '/flutter_flow/flutter_flow_theme.dart';
import '/flutter_flow/flutter_flow_util.dart';
import '/flutter_flow/flutter_flow_widgets.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'mojestatystykiadmiin_model.dart';
export 'mojestatystykiadmiin_model.dart';

class MojestatystykiadmiinWidget extends StatefulWidget {
  const MojestatystykiadmiinWidget({
    super.key,
    this.maczo2,
  });
  ...
  @override
  State<MojestatystykiadmiinWidget> createState() =>
      _MojestatystykiadmiinWidgetState();
}

class _MojestatystykiadmiinWidgetState
    extends State<MojestatystykiadmiinWidget> {
  late MojestatystykiadmiinModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MojestatystykiadmiinModel());
  }
