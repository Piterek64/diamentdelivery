...
import 'historiazlecenrestauracja_model.dart';
export 'historiazlecenrestauracja_model.dart';

class HistoriazlecenrestauracjaWidget extends StatefulWidget {
  const HistoriazlecenrestauracjaWidget({super.key});

  @override
  State<HistoriazlecenrestauracjaWidget> createState() =>
      _HistoriazlecenrestauracjaWidgetState();
}

class _HistoriazlecenrestauracjaWidgetState
    extends State<HistoriazlecenrestauracjaWidget> {
  late HistoriazlecenrestauracjaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HistoriazlecenrestauracjaModel());
  }
