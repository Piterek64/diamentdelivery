...
import 'filtracja_model.dart';
export 'filtracja_model.dart';

class FiltracjaWidget extends StatefulWidget {
  const FiltracjaWidget({super.key});

  @override
  State<FiltracjaWidget> createState() => _FiltracjaWidgetState();
}

class _FiltracjaWidgetState extends State<FiltracjaWidget> {
  late FiltracjaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FiltracjaModel());
  }
