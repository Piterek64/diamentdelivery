...
import 'historiazleceninnegokuriera_model.dart';
export 'historiazleceninnegokuriera_model.dart';

class HistoriazleceninnegokurieraWidget extends StatefulWidget {
  const HistoriazleceninnegokurieraWidget({super.key});

  @override
  State<HistoriazleceninnegokurieraWidget> createState() =>
      _HistoriazleceninnegokurieraWidgetState();
}

class _HistoriazleceninnegokurieraWidgetState
    extends State<HistoriazleceninnegokurieraWidget> {
  late HistoriazleceninnegokurieraModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HistoriazleceninnegokurieraModel());
  }
