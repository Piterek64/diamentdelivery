...
import 'zapisanikurierzy_model.dart';
export 'zapisanikurierzy_model.dart';

class ZapisanikurierzyWidget extends StatefulWidget {
  const ZapisanikurierzyWidget({
    super.key,
    required this.bajka,
  });
  ...
  @override
  State<ZapisanikurierzyWidget> createState() => _ZapisanikurierzyWidgetState();
}

class _ZapisanikurierzyWidgetState extends State<ZapisanikurierzyWidget> {
  late ZapisanikurierzyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ZapisanikurierzyModel());
  }
