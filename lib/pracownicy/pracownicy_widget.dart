...
import 'pracownicy_model.dart';
export 'pracownicy_model.dart';

class PracownicyWidget extends StatefulWidget {
  const PracownicyWidget({super.key});

  @override
  State<PracownicyWidget> createState() => _PracownicyWidgetState();
}

class _PracownicyWidgetState extends State<PracownicyWidget> {
  late PracownicyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PracownicyModel());
  }
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed('Dodajpracownika');
                      },
