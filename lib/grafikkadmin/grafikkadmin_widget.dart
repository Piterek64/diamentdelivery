...
import 'grafikkadmin_model.dart';
export 'grafikkadmin_model.dart';

class GrafikkadminWidget extends StatefulWidget {
  const GrafikkadminWidget({super.key});

  @override
  State<GrafikkadminWidget> createState() => _GrafikkadminWidgetState();
}

class _GrafikkadminWidgetState extends State<GrafikkadminWidget> {
  late GrafikkadminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GrafikkadminModel());
