...
import 'historiazlecenrestauracjaadmin_model.dart';
export 'historiazlecenrestauracjaadmin_model.dart';

class HistoriazlecenrestauracjaadminWidget extends StatefulWidget {
  const HistoriazlecenrestauracjaadminWidget({super.key});

  @override
  State<HistoriazlecenrestauracjaadminWidget> createState() =>
      _HistoriazlecenrestauracjaadminWidgetState();
}

class _HistoriazlecenrestauracjaadminWidgetState
    extends State<HistoriazlecenrestauracjaadminWidget> {
  late HistoriazlecenrestauracjaadminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HistoriazlecenrestauracjaadminModel());
  }
