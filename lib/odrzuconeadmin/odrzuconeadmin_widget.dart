...
import 'odrzuconeadmin_model.dart';
export 'odrzuconeadmin_model.dart';

class OdrzuconeadminWidget extends StatefulWidget {
  const OdrzuconeadminWidget({super.key});

  @override
  State<OdrzuconeadminWidget> createState() => _OdrzuconeadminWidgetState();
}

class _OdrzuconeadminWidgetState extends State<OdrzuconeadminWidget> {
  late OdrzuconeadminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OdrzuconeadminModel());
  }
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        await listViewZamowienieRecord.reference
