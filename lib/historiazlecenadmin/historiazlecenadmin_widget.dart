...
import 'historiazlecenadmin_model.dart';
export 'historiazlecenadmin_model.dart';

class HistoriazlecenadminWidget extends StatefulWidget {
  const HistoriazlecenadminWidget({super.key});

  @override
  State<HistoriazlecenadminWidget> createState() =>
      _HistoriazlecenadminWidgetState();
}

class _HistoriazlecenadminWidgetState extends State<HistoriazlecenadminWidget> {
  late HistoriazlecenadminModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HistoriazlecenadminModel());
  }
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      'Dodano ${dateTimeFormat(
                                        "d/M H:mm",
                                        listViewZamowienieRecord.godzinadodania,
                                        locale: FFLocalizations.of(context)
                                            .languageCode,
                                      )}',
                                      style: FlutterFlowTheme.of(context)
                                                ...
                                                child: Padding(
                                                  padding:
                                                      MediaQuery.viewInsetsOf(
                                                          context),
                                                  child: const ZobaczzdjecieWidget(),
                                                ),
                                              );
                                            },
                                          ).then(
