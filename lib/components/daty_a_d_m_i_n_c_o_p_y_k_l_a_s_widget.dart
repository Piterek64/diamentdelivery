...
import 'daty_a_d_m_i_n_c_o_p_y_k_l_a_s_model.dart';
export 'daty_a_d_m_i_n_c_o_p_y_k_l_a_s_model.dart';

class DatyADMINCOPYKLASWidget extends StatefulWidget {
  const DatyADMINCOPYKLASWidget({super.key});

  @override
  State<DatyADMINCOPYKLASWidget> createState() =>
      _DatyADMINCOPYKLASWidgetState();
}

class _DatyADMINCOPYKLASWidgetState extends State<DatyADMINCOPYKLASWidget> {
  late DatyADMINCOPYKLASModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DatyADMINCOPYKLASModel());
  }
