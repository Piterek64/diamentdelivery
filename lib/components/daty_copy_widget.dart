...
import 'daty_copy_model.dart';
export 'daty_copy_model.dart';

class DatyCopyWidget extends StatefulWidget {
  const DatyCopyWidget({super.key});

  @override
  State<DatyCopyWidget> createState() => _DatyCopyWidgetState();
}

class _DatyCopyWidgetState extends State<DatyCopyWidget> {
  late DatyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DatyCopyModel());
  }
