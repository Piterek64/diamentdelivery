...
import 'datyadim_model.dart';
export 'datyadim_model.dart';

class DatyadimWidget extends StatefulWidget {
  const DatyadimWidget({super.key});

  @override
  State<DatyadimWidget> createState() => _DatyadimWidgetState();
}

class _DatyadimWidgetState extends State<DatyadimWidget> {
  late DatyadimModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DatyadimModel());
  }
