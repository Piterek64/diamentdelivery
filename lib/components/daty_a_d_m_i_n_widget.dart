...
import 'daty_a_d_m_i_n_model.dart';
export 'daty_a_d_m_i_n_model.dart';

class DatyADMINWidget extends StatefulWidget {
  const DatyADMINWidget({super.key});

  @override
  State<DatyADMINWidget> createState() => _DatyADMINWidgetState();
}

class _DatyADMINWidgetState extends State<DatyADMINWidget> {
  late DatyADMINModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DatyADMINModel());
  }
