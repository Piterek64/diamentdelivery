...
import 'innyczaskurier_copy_model.dart';
export 'innyczaskurier_copy_model.dart';

class InnyczaskurierCopyWidget extends StatefulWidget {
  const InnyczaskurierCopyWidget({super.key});

  @override
  State<InnyczaskurierCopyWidget> createState() =>
      _InnyczaskurierCopyWidgetState();
}

class _InnyczaskurierCopyWidgetState extends State<InnyczaskurierCopyWidget> {
  late InnyczaskurierCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InnyczaskurierCopyModel());
                          ...
                          onPressed: () async {
                            await FFAppState()
                                ...
                                .update(createZamowienieRecordData(
                                  ...
                                  kurierminuty: int.tryParse(_model
                                      .innyczaswminutachkurierTextController
                                      .text),
                                  przyjete: true,
                                  dostarczone: false,
