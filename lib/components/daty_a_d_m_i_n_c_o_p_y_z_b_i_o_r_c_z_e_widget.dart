...
import 'daty_a_d_m_i_n_c_o_p_y_z_b_i_o_r_c_z_e_model.dart';
export 'daty_a_d_m_i_n_c_o_p_y_z_b_i_o_r_c_z_e_model.dart';

class DatyADMINCOPYZBIORCZEWidget extends StatefulWidget {
  const DatyADMINCOPYZBIORCZEWidget({super.key});

  @override
  State<DatyADMINCOPYZBIORCZEWidget> createState() =>
      _DatyADMINCOPYZBIORCZEWidgetState();
}

class _DatyADMINCOPYZBIORCZEWidgetState
    extends State<DatyADMINCOPYZBIORCZEWidget> {
  late DatyADMINCOPYZBIORCZEModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DatyADMINCOPYZBIORCZEModel());
  }
                ...
                child: Padding(
                  ...
                  child: AuthUserStreamWidget(
                    builder: (context) => FlutterFlowDropDown<String>(
                      ...
                      options:
                          (currentUserDocument?.zbiorczenazwy.toList() ?? []),
                      onChanged: (val) async {
                        setState(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    if (_model.wybierzrestauracjaeee1Value == 'Wszystkie') {
                      ...
                      _model.otputo = await queryRestauracjaRecordOnce(
                      ...
                      _model.danedozamowienZWYKLARES =
                        ...
                        queryBuilder: (zamowienieRecord) => zamowienieRecord
                            ...
                            .where(
                              'Restauracja',
                              isEqualTo: _model.otputo?.reference,
                            ),
                      );
                      Navigator.pop(
                          context,
