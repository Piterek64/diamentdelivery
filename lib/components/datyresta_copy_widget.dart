...
import 'datyresta_copy_model.dart';
export 'datyresta_copy_model.dart';

class DatyrestaCopyWidget extends StatefulWidget {
  const DatyrestaCopyWidget({super.key});

  @override
  State<DatyrestaCopyWidget> createState() => _DatyrestaCopyWidgetState();
}

class _DatyrestaCopyWidgetState extends State<DatyrestaCopyWidget> {
  late DatyrestaCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DatyrestaCopyModel());
  }
