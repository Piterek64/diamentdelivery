...
import 'datyresta_model.dart';
export 'datyresta_model.dart';

class DatyrestaWidget extends StatefulWidget {
  const DatyrestaWidget({super.key});

  @override
  State<DatyrestaWidget> createState() => _DatyrestaWidgetState();
}

class _DatyrestaWidgetState extends State<DatyrestaWidget> {
  late DatyrestaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DatyrestaModel());
  }
