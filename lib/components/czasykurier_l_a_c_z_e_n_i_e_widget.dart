...
import '/components/innyczaskurier_copy_widget.dart';
import '/components/innyczaskuriergodzina_copy_widget.dart';
import '/flutter_flow/flutter_flow_theme.dart';
import '/flutter_flow/flutter_flow_util.dart';
import '/flutter_flow/flutter_flow_widgets.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'czasykurier_l_a_c_z_e_n_i_e_model.dart';
export 'czasykurier_l_a_c_z_e_n_i_e_model.dart';

class CzasykurierLACZENIEWidget extends StatefulWidget {
  const CzasykurierLACZENIEWidget({super.key});

  @override
  State<CzasykurierLACZENIEWidget> createState() =>
      _CzasykurierLACZENIEWidgetState();
}

class _CzasykurierLACZENIEWidgetState extends State<CzasykurierLACZENIEWidget> {
  late CzasykurierLACZENIEModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CzasykurierLACZENIEModel());
  }
                        ...
                        onPressed: () async {
                          ...
                          await PowiadomienieprzyjalemRecord.collection
                              ...
                              .set(createPowiadomienieprzyjalemRecordData(
                                ...
                                typ: 'Zamówienie przyjęte i połączone!',
                                nazwa:
                                    'Kurier przyjął twoje zamówienie i połączył z innym. Sprawdź zlecenia',
                              ));
                        ...
                        await showModalBottomSheet(
                          ...
                          builder: (context) {
                            return Padding(
                              ...
                              child: const InnyczaskurierCopyWidget(),
                            );
                          },
                      ...
                      onPressed: () async {
                        await showModalBottomSheet(
                          ...
                          builder: (context) {
                            return Padding(
                              padding: MediaQuery.viewInsetsOf(context),
                              child: const InnyczaskuriergodzinaCopyWidget(),
                            );
                          },
                        ).then((value) => safeSetState(() {}));
                      },
