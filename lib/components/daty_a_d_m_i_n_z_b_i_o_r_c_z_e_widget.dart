...
import 'daty_a_d_m_i_n_z_b_i_o_r_c_z_e_model.dart';
export 'daty_a_d_m_i_n_z_b_i_o_r_c_z_e_model.dart';

class DatyADMINZBIORCZEWidget extends StatefulWidget {
  const DatyADMINZBIORCZEWidget({super.key});

  @override
  State<DatyADMINZBIORCZEWidget> createState() =>
      _DatyADMINZBIORCZEWidgetState();
}

class _DatyADMINZBIORCZEWidgetState extends State<DatyADMINZBIORCZEWidget> {
  late DatyADMINZBIORCZEModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DatyADMINZBIORCZEModel());
  }
