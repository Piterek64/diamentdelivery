...
import 'daty_a_d_m_i_n_c_o_p_y_model.dart';
export 'daty_a_d_m_i_n_c_o_p_y_model.dart';

class DatyADMINCOPYWidget extends StatefulWidget {
  const DatyADMINCOPYWidget({super.key});

  @override
  State<DatyADMINCOPYWidget> createState() => _DatyADMINCOPYWidgetState();
}

class _DatyADMINCOPYWidgetState extends State<DatyADMINCOPYWidget> {
  late DatyADMINCOPYModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DatyADMINCOPYModel());
  }
