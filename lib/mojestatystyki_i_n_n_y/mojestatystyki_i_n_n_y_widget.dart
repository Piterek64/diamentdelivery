import '/components/daty_i_n_n_y_widget.dart';
import '/components/daty_i_n_n_ycopy_widget.dart';
import '/flutter_flow/flutter_flow_theme.dart';
import '/flutter_flow/flutter_flow_util.dart';
import '/flutter_flow/flutter_flow_widgets.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'mojestatystyki_i_n_n_y_model.dart';
export 'mojestatystyki_i_n_n_y_model.dart';

class MojestatystykiINNYWidget extends StatefulWidget {
  const MojestatystykiINNYWidget({
    super.key,
    this.maczo2,
  });
  ...
  @override
  State<MojestatystykiINNYWidget> createState() =>
      _MojestatystykiINNYWidgetState();
}

class _MojestatystykiINNYWidgetState extends State<MojestatystykiINNYWidget> {
  late MojestatystykiINNYModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MojestatystykiINNYModel());
  }
                            ...
                            builder: (context) {
                              return GestureDetector(
                                ...
                                child: Padding(
                                  ...
                                  child: const DatyINNYcopyWidget(),
                                ),
                              );
                            },
                          ).then((value) =>
