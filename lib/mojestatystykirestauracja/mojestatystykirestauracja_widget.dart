...
import '/components/datyresta_widget.dart';
import '/flutter_flow/flutter_flow_theme.dart';
import '/flutter_flow/flutter_flow_util.dart';
import '/flutter_flow/flutter_flow_widgets.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'mojestatystykirestauracja_model.dart';
export 'mojestatystykirestauracja_model.dart';

class MojestatystykirestauracjaWidget extends StatefulWidget {
  const MojestatystykirestauracjaWidget({
    super.key,
    this.maczo,
  });

  final List<DocumentReference>? maczo;

  @override
  State<MojestatystykirestauracjaWidget> createState() =>
      _MojestatystykirestauracjaWidgetState();
}

class _MojestatystykirestauracjaWidgetState
    extends State<MojestatystykirestauracjaWidget> {
  late MojestatystykirestauracjaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MojestatystykirestauracjaModel());
  }
