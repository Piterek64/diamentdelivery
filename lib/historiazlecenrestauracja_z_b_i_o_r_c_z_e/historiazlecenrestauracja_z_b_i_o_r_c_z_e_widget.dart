...
import 'historiazlecenrestauracja_z_b_i_o_r_c_z_e_model.dart';
export 'historiazlecenrestauracja_z_b_i_o_r_c_z_e_model.dart';

class HistoriazlecenrestauracjaZBIORCZEWidget extends StatefulWidget {
  const HistoriazlecenrestauracjaZBIORCZEWidget({super.key});

  @override
  State<HistoriazlecenrestauracjaZBIORCZEWidget> createState() =>
      _HistoriazlecenrestauracjaZBIORCZEWidgetState();
}

class _HistoriazlecenrestauracjaZBIORCZEWidgetState
    extends State<HistoriazlecenrestauracjaZBIORCZEWidget> {
  late HistoriazlecenrestauracjaZBIORCZEModel _model;
  ...
  void initState() {
    super.initState();
    _model =
        createModel(context, () => HistoriazlecenrestauracjaZBIORCZEModel());
  }
                ...
                Padding(
                  ...
                  child: AuthUserStreamWidget(
                    builder: (context) => PagedListView<
                        DocumentSnapshot<Object?>?, ZamowienieRecord>.separated(
